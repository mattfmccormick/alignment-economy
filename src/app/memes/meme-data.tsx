...
function Site() {
  return <div style={{ padding: "8px 28px 12px", textAlign: "center", fontSize: "10px", letterSpacing: "1px", color: muted, fontFamily: "'Courier New',monospace" }}>alignmenteconomy.org</div>;
}
function C({ center, children }: { center?: boolean; children: React.ReactNode }) {
  return <div style={{ width: "100%", minHeight: "280px", background: bg1, display: "flex", flexDirection: "column", position: "relative", overflow: "visible", ...(center ? { justifyContent: "center", alignItems: "center", padding: "40px" } : {}) }}>{children}<Site/></div>;
}
...
const memes = [
  ...
  { stage:1, id:"taxes-print", render:()=><C center><div style={{color:sub,fontSize:"14px",fontFamily:"'Georgia',serif",lineHeight:1.6,maxWidth:"300px",textAlign:"left",marginBottom:"16px"}}>&ldquo;Dad, before you go, can I ask you a question?&rdquo;<br/><br/>&ldquo;Sure, son.&rdquo;<br/><br/>&ldquo;Why are we forced to pay taxes? Don&apos;t they print all the money they want anyway?&rdquo;</div><Sp/><div style={{display:"flex",alignItems:"center",gap:"8px"}}><span style={{fontSize:"24px"}}>🕓</span><span style={{color:muted,fontSize:"13px"}}>4:37 AM</span></div><div style={{color:navy,fontSize:"15px",fontFamily:"'Georgia',serif",fontWeight:"bold",marginTop:"12px"}}>It&apos;s theft, son.</div></C> },
  ...
  { stage:2, id:"grandma-explain", render:()=><C center><div style={{fontSize:"48px",marginBottom:"12px"}}>👵</div><div style={{color:sub,fontSize:"14px",fontFamily:"'Georgia',serif",lineHeight:1.8,maxWidth:"300px",textAlign:"left"}}>&ldquo;So it&apos;s like Pok&eacute;mon cards?&rdquo;<br/><br/>&ldquo;No Grandma, it&apos;s different. Just download this app, run this code, and don&apos;t forget this 24-word recovery phrase.&rdquo;<br/><br/>&ldquo;...&rdquo;<br/><br/>&ldquo;Also never share it, write it on paper, hide the paper, and if you lose it your money is gone forever.&rdquo;</div><P>If explaining it sounds insane,<br/>maybe the system is.</P></C> },

  { stage:2, id:"btc-first-mover", render:()=><C><T>Early vs. late adoption</T><R2><H2 br><div style={{fontSize:"48px",marginBottom:"8px"}}>🪙</div><div style={{color:orange,fontSize:"28px",fontWeight:"bold",fontFamily:"'Georgia',serif"}}>2012</div><div style={{color:sub,fontSize:"13px",marginTop:"8px",textAlign:"center",lineHeight:1.6}}>Buy 100 BTC<br/>for <span style={{color:orange,fontWeight:"bold"}}>$1,200</span></div><div style={{color:orange,fontSize:"11px",marginTop:"8px"}}>Sit on a beach</div></H2><H2><div style={{fontSize:"48px",marginBottom:"8px"}}>🧱</div><div style={{color:muted,fontSize:"28px",fontWeight:"bold",fontFamily:"'Georgia',serif"}}>2030</div><div style={{color:sub,fontSize:"13px",marginTop:"8px",textAlign:"center",lineHeight:1.6}}>Buy 0.01 BTC<br/>for <span style={{color:red,fontWeight:"bold"}}>$1,200</span></div><div style={{color:red,fontSize:"11px",marginTop:"8px"}}>Hope it goes up more</div></H2></R2><P>Same money in. Wildly different outcome.<br/>That&apos;s not a currency. That&apos;s a lottery ticket.</P></C> },
  ...
  // STAGE 3: HOW THE ALIGNMENT ECONOMY WORKS (9)
  // ───────────────────────────────────────

  { stage:3, id:"no-first-mover", render:()=><C><T>No first-mover advantage</T><M gap="16px"><div style={{color:sub,fontSize:"13px",fontFamily:"'Georgia',serif",lineHeight:1.6}}>Early Bitcoin adopters became billionaires. Late adopters got the bill.</div><div style={{color:teal,fontSize:"18px",fontFamily:"'Georgia',serif",fontWeight:"bold",lineHeight:1.6}}>In the Alignment Economy, everyone gets the same daily allocation. Day one or day ten thousand.</div></M><P>No insiders. No presale. No &ldquo;sorry you&apos;re late.&rdquo;</P></C> },

  { stage:3, id:"no-inflation", render:()=><C><T>No inflation, no deflation</T><M gap="16px"><div style={{color:sub,fontSize:"13px",fontFamily:"'Georgia',serif",lineHeight:1.6}}>The dollar lost 97% of its value since 1913. Bitcoin swings 30% in a week.</div><div style={{color:teal,fontSize:"18px",fontFamily:"'Georgia',serif",fontWeight:"bold",lineHeight:1.6}}>The Alignment Economy rebases daily. Your purchasing power stays stable by design, not by hope.</div></M><P>Sound money that actually acts like it.</P></C> },

  { stage:3, id:"her-work-counts", render:()=><C><T>Her work finally counts</T><M gap="16px"><div style={{color:sub,fontSize:"13px",fontFamily:"'Georgia',serif",lineHeight:1.6}}>She raises the kids. Runs the house. Holds it all together.</div><div style={{color:teal,fontSize:"18px",fontFamily:"'Georgia',serif",fontWeight:"bold",lineHeight:1.6}}>GDP says that&apos;s worth /usr/bin/bash. The Alignment Economy says it&apos;s worth points, every single day.</div></M><P>If it sustains a household, it sustains an economy.</P></C> },

  { stage:3, id:"ai-proof", render:()=><C><T>AI-proof</T><M gap="16px"><div style={{color:sub,fontSize:"13px",fontFamily:"'Georgia',serif",lineHeight:1.6}}>AI is coming for your job. Nobody has a plan for what happens after.</div><div style={{color:teal,fontSize:"18px",fontFamily:"'Georgia',serif",fontWeight:"bold",lineHeight:1.6}}>The Alignment Economy does. Human value isn&apos;t measured by what a machine can replace.</div></M><P>Built for the economy AI is about to break.</P></C> },

  { stage:3, id:"proof-of-human", render:()=><C><T>Proof of human</T><M gap="16px"><div style={{color:sub,fontSize:"13px",fontFamily:"'Georgia',serif",lineHeight:1.6}}>Deepfakes can clone your face, your voice, your signature. So how do you prove you&apos;re real?</div><div style={{color:teal,fontSize:"18px",fontFamily:"'Georgia',serif",fontWeight:"bold",lineHeight:1.6}}>Proof of Human. And you choose how it works, not a government, not a corporation. You.</div></M><P>Your identity. Your rules.</P></C> },

  { stage:3, id:"obsolescence-over", render:()=><C><T>Planned obsolescence is over</T><M gap="16px"><div style={{color:sub,fontSize:"13px",fontFamily:"'Georgia',serif",lineHeight:1.6}}>Your phone is designed to break in 2 years. Your fridge used to last 30.</div><div style={{color:teal,fontSize:"18px",fontFamily:"'Georgia',serif",fontWeight:"bold",lineHeight:1.6}}>The Alignment Economy rewards things that last. Build it once. Build it right.</div></M><P>An economy that stops rewarding waste.</P></C> },

  { stage:3, id:"govt-report-card", render:()=><C><T>Government gets a report card</T><M gap="16px"><div style={{color:sub,fontSize:"13px",fontFamily:"'Georgia',serif",lineHeight:1.6}}>Your taxes disappear into a black box. You find out what happened (maybe) years later.</div><div style={{color:teal,fontSize:"18px",fontFamily:"'Georgia',serif",fontWeight:"bold",lineHeight:1.6}}>Ambient taxation gives government a real-time report card. Every allocation, visible. Every result, measurable.</div></M><P>Transparency isn&apos;t optional. It&apos;s the architecture.</P></C> },

  { stage:3, id:"not-politicians", render:()=><C><T>Not controlled by politicians</T><M gap="16px"><div style={{color:sub,fontSize:"13px",fontFamily:"'Georgia',serif",lineHeight:1.6}}>Every 4 years, the rules change. New administration, new priorities, same broken incentives.</div><div style={{color:teal,fontSize:"18px",fontFamily:"'Georgia',serif",fontWeight:"bold",lineHeight:1.6}}>The Alignment Economy runs on a blockchain. The rules are the rules. No one person gets to rewrite them.</div></M><P>Coordination, not capture.</P></C> },

  { stage:3, id:"works-with-existing", render:()=><C><T>Works with what exists</T><M gap="16px"><div style={{color:sub,fontSize:"13px",fontFamily:"'Georgia',serif",lineHeight:1.6}}>&ldquo;So you want to replace the dollar?&rdquo;</div><div style={{color:teal,fontSize:"18px",fontFamily:"'Georgia',serif",fontWeight:"bold",lineHeight:1.6}}>No. The Alignment Economy is a bridge. It works alongside existing systems while building something better underneath.</div></M><P>You don&apos;t have to burn it down to build it up.</P></C> },
